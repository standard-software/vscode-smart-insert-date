...
```json
{
  ...
  "SmartInsertDate.DateTimeFormat": [
    ...
    { "format": "YYYY/MM/DD(DDD) HH:mm:ss" },
    { "format": "YYYY/MM/DD DDD曜 HH:mm:ss" },
    { "format": "YYYY-MM-DD ddd HH:mm:ss" },
    ...
    { "format": "GE年MM月DD日 DDDD AAAhh時mm分" },
    { "format": "GGE年MM月DD日 DDDD AAAhh時mm分" },
    { "format": "GGGEE年MM月DD日 DDDD AAAhh時mm分" },
  ...
  "SmartInsertDate.MenuDateTime": [
    {
      ...
      "items": [
        ...
        { "format": "YYYY-MM-DD(DDD) hh:mm:ss aa" },
        { "format": "YYYY-MM-DD DDD曜 hh:mm:ss aa" },
        { "format": "YYYY-MM-DD DDDD hh:mm:ss aa" },
        { "format": "YYYY-MM-DD(DDD) AA hh:mm:ss" },
        { "format": "YYYY-MM-DD DDD曜 AA hh:mm:ss" },
        { "format": "YYYY-MM-DD DDDD AA hh:mm:ss" },
        {
          "label": "+Time 24",
          "separator": true
        },
      ...
      "items": [
        ...
        },
        {
          ...
          "items": [
            ...
            { "format": "YYYYMMDD(DDD) hh:mm:ss aa" },
            { "format": "YYYYMMDD DDD曜 hh:mm:ss aa" },
            { "format": "YYYYMMDD DDDD hh:mm:ss aa" },
            { "format": "YYYYMMDD(DDD) AA hh:mm:ss" },
            { "format": "YYYYMMDD DDD曜 AA hh:mm:ss" },
            { "format": "YYYYMMDD DDDD AA hh:mm:ss" },
            {
              "label": "+Time 24",
              "separator": true
            },
