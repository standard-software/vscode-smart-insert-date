      ...
      "items": [
        ...
        },
        {
          ...
          "items": [
            ...
            { "format": "ddd, MMM DD, YYYY hh:mm aa" },
            { "format": "dddd, MMM DD, YYYY hh:mm aa" }
          ]
        },
        {
          "label": "'+Time 24'",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "label": "'+Time 12'",
          "items": [
            { "format": "MMMMM DD, YYYY hh:mm aa" },
            { "format": "ddd, MMMMM DD, YYYY hh:mm aa" },
            { "format": "dddd, MMMMM DD, YYYY hh:mm aa" }
          ]
        },
        {
          "label": "'+Time 24'",
          "items": [
            { "format": "MMMMM DD, YYYY HH:mm" },
            { "format": "ddd, MMMMM DD, YYYY HH:mm" },
            { "format": "dddd, MMMMM DD, YYYY HH:mm" }
          ]
        }
      ]
    },
      ...
      "items": [
        ...
        },
        {
          ...
          "items": [
            ...
            { "format": "ddd, MM DD, YYYY hh:mm aa" },
            { "format": "dddd, MM DD, YYYY hh:mm aa" }
          ]
        },
        {
      ...
      "items": [
        ...
        },
        {
          ...
          "items": [
            ...
            { "format": "ddd, DD MMM, YYYY hh:mm aa" },
            { "format": "dddd, DD MMM, YYYY hh:mm aa" }
          ]
        },
        {
          "label": "'+Time 24'",
